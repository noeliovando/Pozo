 ...
 * @property string $row_changed_by
 * @property string $row_changed_date
 */
class Pozos extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['uwi', 'well_name', 'well_number', 'drillers_td', 'elevation', 'block_id', 'location_table', 'field_name', 'well_alias', 'plot_name', 'ground_elevation', 'spud_date', 'inicio_perf', 'fin_drill', 'comp_date', 'primary_source', 'class', 'operator', 'form_at_td', 'tvd', 'log_td', 'prov_st', 'country', 'county', 'discover_well', 'agent', 'description', 'district', 'govt_assigned_no', 'whipstock_depth', 'rig_no', 'contractor', 'geologic_providence', 'hole_direction', 'initial_class', 'node_x', 'node_y', 'latitude', 'longitude', 'datum', 'inserted_by', 'insert_date', 'row_changed_by', 'row_changed_date'], 'required'],
            [['well_number'], 'integer'],
            [['spud_date', 'inicio_perf', 'fin_drill', 'comp_date', 'insert_date', 'row_changed_date'], 'safe'],
            [['uwi'], 'string', 'max' => 16],
            ...
            [['inserted_by', 'row_changed_by'], 'string', 'max' => 50]
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'spud_date' => 'Spud Date',
            'inicio_perf' => 'Inicio Perforacion',
            'fin_drill' => 'Fin Drill',
            ...
            'row_changed_by' => 'Row Changed By',
            'row_changed_date' => 'Row Changed Date',
        ];
    }
}
